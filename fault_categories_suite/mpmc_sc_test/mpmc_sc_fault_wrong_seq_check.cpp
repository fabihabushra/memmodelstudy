    ...
    bool dequeue(std::uint64_t& value) {
        ...
        while (true) {
            ...
            if (seq == pos) {
                ...
                return false; // faulty companion logic
            }
...
struct mpmc_sc_fault_wrong_seq_check_test
    : rl::test_suite<mpmc_sc_fault_wrong_seq_check_test, THREADS> {
    MPMCQueue q;
...
int main() {
    rl::simulate<mpmc_sc_fault_wrong_seq_check_test>();
    return 0;
}
