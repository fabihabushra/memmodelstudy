    ...
    bool enqueue(std::uint64_t value) {
        ...
        while (true) {
            ...
            if (seq == pos) {
                ...
                STORE_ENQ_POS(this, pos + 1, memory_order_seq_cst);
...
struct mpmc_sc_fault_producer_no_cas_test
    : rl::test_suite<mpmc_sc_fault_producer_no_cas_test, THREADS> {
    MPMCQueue q;
...
int main() {
    rl::simulate<mpmc_sc_fault_producer_no_cas_test>();
    return 0;
}
