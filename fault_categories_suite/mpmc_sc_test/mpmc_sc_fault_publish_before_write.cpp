        ...
        while (true) {
            ...
            if (seq == pos) {
                ...
                if (CAS_ENQ_POS(this, expected, pos + 1,
                                ...
                                memory_order_seq_cst)) {
                    // faulty: publish slot as ready before writing value
...
struct mpmc_sc_fault_publish_before_write_test
    : rl::test_suite<mpmc_sc_fault_publish_before_write_test, THREADS> {
    MPMCQueue q;
...
int main() {
    rl::simulate<mpmc_sc_fault_publish_before_write_test>();
    return 0;
}
