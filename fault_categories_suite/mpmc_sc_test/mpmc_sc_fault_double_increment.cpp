    ...
    bool enqueue(std::uint64_t value) {
        ...
        while (true) {
            ...
            if (seq == pos) {
                ...
                // faulty: claim jumps by 2
                if (CAS_ENQ_POS(this, expected, pos + 2,
...
struct mpmc_sc_fault_double_increment_test
    : rl::test_suite<mpmc_sc_fault_double_increment_test, THREADS> {
    MPMCQueue q;
...
int main() {
    rl::simulate<mpmc_sc_fault_double_increment_test>();
    return 0;
}
