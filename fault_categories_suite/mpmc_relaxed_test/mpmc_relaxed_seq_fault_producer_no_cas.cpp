    ...
    bool enqueue(std::uint64_t value) {
        ...
        while (true) {
            ...
            if (seq == pos) {
                ...
                STORE_ENQ_POS(this, pos + 1, memory_order_release);
...
struct mpmc_relaxed_seq_fault_producer_no_cas_test
    : rl::test_suite<mpmc_relaxed_seq_fault_producer_no_cas_test, THREADS> {
    MPMCQueue q;
...
int main() {
    rl::simulate<mpmc_relaxed_seq_fault_producer_no_cas_test>();
    return 0;
}
