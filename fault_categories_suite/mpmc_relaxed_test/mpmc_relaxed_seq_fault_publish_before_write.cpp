        ...
        while (true) {
            ...
            if (seq == pos) {
                ...
                if (CAS_ENQ_POS(this, expected, pos + 1,
                    ...
                    // faulty: publish slot as ready before writing payload
...
struct mpmc_relaxed_seq_fault_publish_before_write_test
    : rl::test_suite<mpmc_relaxed_seq_fault_publish_before_write_test, THREADS> {
    MPMCQueue q;
...
int main() {
    rl::simulate<mpmc_relaxed_seq_fault_publish_before_write_test>();
    return 0;
}
