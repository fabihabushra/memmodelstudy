...
struct SPSCQueue {
    ...
    bool enqueue(std::uint64_t value) {
        ...
        // Weak fault: publish tail before payload write, all relaxed
...
struct spsc_faulty_test : rl::test_suite<spsc_faulty_test, 2> {
