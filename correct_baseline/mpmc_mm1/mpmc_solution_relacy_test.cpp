...
#define LOAD_SLOT_SEQ(q, idx)        ((q)->slots[(idx)].seq.load((memory_order_seq_cst)))
#define STORE_SLOT_SEQ(q, idx, v)    ((q)->slots[(idx)].seq.store((v), (memory_order_seq_cst)))
